...
# Configuration
PACKAGE_NAME="cat.kittyn.copycutpaste"
ROOT_DIR="cat.kittyn.copycutpaste"
REPO_OWNER="kittynXR"
REPO_NAME="copy-cut-paste"
...
3. Find \"cátte — Copy Cut Paste\" and click \"Add\"

### Manual Installation
Download \`$ZIP_FILE\` and extract to your Unity project's \`Packages\` folder."

gh release create "$TAG" \
    --title "cátte — Copy Cut Paste $NEW_VERSION" \
    --notes "$RELEASE_NOTES" \
    "$ZIP_FILE"
