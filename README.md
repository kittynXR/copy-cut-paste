...
Adds Copy, Cut, and Paste functionality to Unity assets.

## Installation

### VRChat Creator Companion (Recommended)
1. In VCC, click "Manage Project"
2. Add the repository: `https://copy-cut-paste.kittyn.cat/index.json`
3. Find "cátte — Copy Cut Paste" in the package list and click "Add"

### Manual Installation
1. Download the latest release from [Releases](https://github.com/kittynXR/copy-cut-paste/releases)
2. Extract the zip file to your Unity project's `Packages` folder

## Documentation

See the [package README](kittyncat_tools/cat.kittyn.copycutpaste/README.md) for detailed usage instructions.
...
- [VPM Repository](https://copy-cut-paste.kittyn.cat/index.json)
- [GitHub Releases](https://github.com/kittynXR/copy-cut-paste/releases)
